...
with pm.Model() as categorical_model:
    ...
    a = pm.Normal("intercept", mu=0, sigma=1.0, shape=nbr_classes)# intercepts
    b = pm.Normal("age", mu=0, sigma=1.5, shape=nbr_classes)
    c = pm.Normal("gender", mu=0, sigma=1.5, shape=nbr_classes)
    d = pm.Normal("smoking", mu=0, sigma=1.5, shape=nbr_classes)
    e = pm.Normal("fever", mu=0, sigma=1.5, shape=nbr_classes)
    f = pm.Normal("vomiting", mu=0, sigma=1.5, shape=nbr_classes)
